...
// Copyright (c) 2013 The C-Note developers
...
uint256 hashGenesisBlock("0x00000761d34428953a5de9b39e85404a15dec719f196d4385cb0fd79ab55d24e");
static const unsigned int timeGenesisBlock = 1387677831;
...
static const int64 nGenesisBlockRewardCoin = .0001 * COIN;
static const int64 nBlockRewardStartCoin = 100 * COIN;
static const int64 nBlockRewardMinimumCoin = 100 * COIN;

static const int64 nTargetTimespan = 100 * 100; // 10,000 seconds
static const int64 nTargetSpacing = 100; // 100 seconds
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x0d7647d5755faf897a2416ab51b65ad2f3608cd504610efe61abc464414db7b5"));
...
unsigned char pchMessageStart[4] = { 0x05, 0xfe, 0xa5, 0x03 };
...
{
    printf("C-NoteMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("c-note-miner");
    ...
    try { loop {
        ...
        printf("Running C-NoteMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
